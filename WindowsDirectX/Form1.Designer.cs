namespace DirectXDisplay
{
	partial class Form1
	{
		...
		{ 
			this.direct2DControlWinForm1 = new DirectXDisplay.Direct2DControlWinForm();
			this.SuspendLayout();
			// 
			...
			this.direct2DControlWinForm1.Size = new System.Drawing.Size(497, 260);
			this.direct2DControlWinForm1.TabIndex = 0;
			// 
			// Form1
			// 
		...
		private Direct2DControlWinForm direct2DControlWinForm1;
